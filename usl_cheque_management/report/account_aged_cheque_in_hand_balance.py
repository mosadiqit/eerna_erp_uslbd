...
class ReportAgedChequeInHandBalance(models.AbstractModel):
    _name = 'report.usl_cheque_management.report_agedchequeinhandbalance'
    _description = 'Aged Cheque In Hand Balance Report'
