...
class StockReturnInherit(models.TransientModel):
    ...
    def _create_returns(self):
        ...
        picking_val = self.env['stock.picking.type'].search([('default_location_dest_id','=',self.picking_id.location_id.id),('is_warehouse_return','=',True)])
        if picking_val:
            picking_type_id = picking_val.id
        else:
