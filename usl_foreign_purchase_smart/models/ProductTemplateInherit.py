...
class ProbationalAttributeSetup(models.Model):
    ...
    product_probational_tmpl_id1 = fields.Many2one('product.template')
    product_probational_tmpl_id = fields.Many2one('product.template', domain=[('probational_cost_ok','=',True)])
