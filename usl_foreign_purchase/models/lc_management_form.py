...
class LcManagementForm(models.Model):
    ...
    bank_name = fields.Many2one('bank_info.all_bank', string='Bank Name', required=True)
    bank_state = fields.Char(string='Address state', related='bank_name.address')
    bank_state2 = fields.Char(string='Address state2', related='bank_name.address')
    bank_city = fields.Char(string='Address City', related='bank_name.address')
    bank_country = fields.Char(string='Address Country', related='bank_name.address')
    ...
    remaining_amount=fields.Integer(default=0.0,string="Remaining Amount",readonly=1)
